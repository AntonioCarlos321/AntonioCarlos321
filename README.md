...
💻 Experiência com projetos usando **WebSocket**, **Node.js**, **JavaScript**, **HTML** e **CSS**<br>
📡 Especializado em desenvolver **chats, sistemas interativos e comunicação em tempo real**
...
### 💬 Chat em Tempo Real  
Sistema de chat simples e eficiente, construído com **JavaScript, Node.js e WebSocket**, com foco em performance, conexões simultâneas e experiência fluida.  
> 🔐 Login seguro | 💬 Mensagens instantâneas | 🖥️ Interface responsiva com HTML e CSS
